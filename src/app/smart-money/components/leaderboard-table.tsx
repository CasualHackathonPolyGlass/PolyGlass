...
type SortField = "totalPnl" | "roi" | "winRate" | "tradeCount" | "marketCount";
    ...
    <div className="flex flex-col gap-4">
      ...
      <div className="overflow-x-auto rounded-xl border border-white/10 bg-white/5">
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b border-white/10 text-left text-xs text-white/50">
              ...
              <th
                className="cursor-pointer px-4 py-4 font-medium hover:text-white"
                onClick={() => handleSort("totalPnl")}
              >
                <div className="flex items-center gap-1">
                  Total PnL
                  <SortIcon active={sortField === "totalPnl"} direction={sortDirection} />
                </div>
              </th>
              <th
                className="cursor-pointer px-4 py-4 font-medium hover:text-white"
              ...
              >
                <div className="flex items-center gap-1">
                  ROI
                  <SortIcon active={sortField === "roi"} direction={sortDirection} />
                </div>
              </th>
              <th
                className="cursor-pointer px-4 py-4 font-medium hover:text-white"
              ...
              >
                <div className="flex items-center gap-1">
                  Win Rate
                  <SortIcon active={sortField === "winRate"} direction={sortDirection} />
                </div>
              </th>
              <th
                className="cursor-pointer px-4 py-4 font-medium hover:text-white"
              ...
              >
                <div className="flex items-center gap-1">
                  Trades
                  <SortIcon active={sortField === "tradeCount"} direction={sortDirection} />
                </div>
              </th>
              <th
                className="cursor-pointer px-4 py-4 font-medium hover:text-white"
              ...
              >
                <div className="flex items-center gap-1">
                  Markets
                  <SortIcon active={sortField === "marketCount"} direction={sortDirection} />
                </div>
              </th>
            </tr>
          </thead>
          <tbody className="divide-y divide-white/5">
            {paginatedData.map((entry, idx) => {
              ...
              return (
                <tr key={entry.address} className="transition hover:bg-white/5">
                  ...
                  <td className="px-4 py-4">
                    <div className="flex items-center gap-2">
                      <span className="font-medium text-white">{entry.winRate}%</span>
                  ...
                  <td className="px-4 py-4 font-mono text-white/70">{entry.marketCount}</td>
                </tr>
              );
            })}
          </tbody>
        ...
        {paginatedData.length === 0 && (
          <div className="py-12 text-center text-white/50">No data available</div>
        )}
      </div>
